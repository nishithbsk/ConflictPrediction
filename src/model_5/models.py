...
def network_climate(input_tensor):
    return (pt.wrap(input_tensor).
            conv2d(3, 2, stride=1, name='climate_conv1').
            conv2d(5, 5, stride=1, name='climate_conv2').
            flatten().
            fully_connected(64, activation_fn=None, name='climate_fc1')).tensor
